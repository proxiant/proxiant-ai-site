        ...
        <div className="mesh aspect-[4/5] scanline relative">
          ...
          <div className="absolute inset-0 grid place-items-center">
            <div className="text-center">
              <div className="font-mono text-[11px] tracking-[0.2em] text-white/70 mb-3">LABS</div>
              <div className="font-serif italic text-[clamp(48px,6vw,96px)] text-white leading-none">02</div>
