...
export const metadata: Metadata = {
  title: "Telecom — Proxiant",
  description: "Network operations, customer-care assistants, and churn intervention at carrier volume.",
};
...
<header data-theme="light" className="relative pt-40 pb-20 lg:pt-56 lg:pb-28">
  ...
  <div className="container-x relative">
    ...
    <div className="grid lg:grid-cols-12 gap-10 items-end">
      ...
      <PageMarquee
        items={["Detect", "Triage", "Resolve", "Retain", "Plan"]}
  ...
  <div className="container-x">
    <div className="grid lg:grid-cols-12 gap-10 lg:gap-16">
      ...
      <PinScroll
        ...
        title="Carrier-volume ready."
        theme="light"
        words={[{ text: "Detect" }, { text: "Triage", em: true }, { text: "Resolve" }, { text: "Retain", em: true }]}
      />
