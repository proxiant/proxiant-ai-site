...
export const metadata: Metadata = {
  title: "Trustworthy AI — Proxiant Insights",
  description: "A working playbook for evaluation, red-teaming, and governance that survives a real auditor walking the floor.",
};
